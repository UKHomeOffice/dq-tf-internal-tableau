  ...
  "Statement": [
    {
      ...
      "Resource": [
        ...
        "arn:aws:ssm:eu-west-2:*:parameter/tableau_int_tableau_server_repository_username",
        "arn:aws:ssm:eu-west-2:*:parameter/tableau_int_tableau_server_repository_password",
