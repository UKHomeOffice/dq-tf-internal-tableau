  ...
  "Statement": [
    {
      ...
      "Resource": [
        ...
        "arn:aws:ssm:eu-west-2:*:parameter/tableau_int_wip_openid_provider_client_id",
        "arn:aws:ssm:eu-west-2:*:parameter/tableau_int_wip_openid_client_secret",
        "arn:aws:ssm:eu-west-2:*:parameter/tableau_int_wip_openid_provider_config_url",
        "arn:aws:ssm:eu-west-2:*:parameter/tableau_int_wip_openid_tableau_server_external_url",
