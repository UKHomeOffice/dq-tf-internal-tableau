...
class TestE2E(unittest.TestCase):
    ...
    def test_rds_disk_size(self):
        self.assertEqual(self.runner.get_value("module.root_modules.aws_db_instance.postgres", "allocated_storage"), 4000)
    ...
    def test_rds_postgres_postgres_engine_version(self):
        self.assertEqual(self.runner.get_value("module.root_modules.aws_db_instance.postgres", "engine_version"), "14.15")
