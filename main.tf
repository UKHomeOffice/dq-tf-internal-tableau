...
export TAB_PRODUCT_KEY_1=`aws --region eu-west-2 ssm get-parameter --name tableau_int_product_key_1:1 --query 'Parameter.Value' --output text --with-decryption`
export TAB_PRODUCT_KEY_2=`aws --region eu-west-2 ssm get-parameter --name tableau_int_product_key_2:1 --query 'Parameter.Value' --output text --with-decryption`
export TAB_PRODUCT_KEY_3=`aws --region eu-west-2 ssm get-parameter --name tableau_int_product_key_3:1 --query 'Parameter.Value' --output text --with-decryption`
export TAB_PRODUCT_KEY_4=`aws --region eu-west-2 ssm get-parameter --name tableau_int_product_key_4:1 --query 'Parameter.Value' --output text --with-decryption`
